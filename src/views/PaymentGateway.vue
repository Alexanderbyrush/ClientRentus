            ...
            <div v-if="currentStep === 1" class="step-body">
                ...
                <div class="method-list">
                    <div v-for="method in paymentMethods" :key="method.id"
                        :class="{ 'method-card-selected': selectedMethod?.id === method.id }" class="method-card"
                ...
                <button @click="currentStep = 2" :disabled="!selectedMethod" class="btn-continue">
                    Continuar
                </button>
            </div>
...
.btn-confirm {
    ...
    /* Rojo para confirmar acción crítica */
    color: white;
    border: none;
    border-radius: 10px;
    font-weight: 700;
